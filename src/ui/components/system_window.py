...
class UpgradeBox(ctk.CTkFrame):
    def __init__(self, master, **kwargs) -> None:
        ...
        self.stat_label = ctk.CTkLabel(self, text="Health", font=("ELNATH", 20))
        ...
        self.upgrade_value = ctk.CTkLabel(upgrade_values_frame, text="+50", text_color='#3dba44', font=("Geist Mono", 30, "bold"))
        self.upgrade_value.pack(pady=10, expand=True, fill='both')

        currency_icon = ImageTk.PhotoImage(CURRENCY_ICON)
        self.upgrade_button = ctk.CTkButton(self, text="200", fg_color='#1e5421', font=("Geist Mono", 26), image=currency_icon, compound='right')
...
class SystemWindow(ctk.CTkFrame):
    def __init__(self, master, height=800, width=950, **kwargs) -> None:
        ...
        for i in range(4):
            ...
            upgrade_box.grid(row=0, column=i, sticky='nsew', pady=10, padx=10)
